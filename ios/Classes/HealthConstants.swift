...
enum HealthConstants {
    ...
    static let CLINICAL_ALLERGY_INTOLERANCE = "CLINICAL_ALLERGY_INTOLERANCE"
    static let CLINICAL_CONDITION = "CLINICAL_CONDITION"
    static let CLINICAL_COVERAGE = "CLINICAL_COVERAGE"
    static let CLINICAL_IMMUNIZATION = "CLINICAL_IMMUNIZATION"
    static let CLINICAL_LAB_RESULT = "CLINICAL_LAB_RESULT"
    static let CLINICAL_MEDICATION = "CLINICAL_MEDICATION"
    static let CLINICAL_PROCEDURE = "CLINICAL_PROCEDURE"
    static let CLINICAL_VITAL_SIGN = "CLINICAL_VITAL_SIGN"
